...
<body>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="alert alert-primary mt-2" role="alert">
            <h4 class="alert-heading">こちらはゲスト専用ページです</h4>
            <p class="mb-0">監視を行うには、ログインが必要です</p>
          </div>
        </div>
      </div>
      <div class="row" style="">
        <div class="col-md-12 my-5 text-lg-left text-center align-self-center" style="">
          <div class="row">
            <div class="col-md-7 text-center" style="">
              <h1 class="text-body display-4">Virtual Control</h1>
              <p class="lead">A Controling Network&nbsp;Tool</p>
              <h5 class="">本サーバは Virtual Control により<br>運用されています<br></h5>
            </div>
            <div class="col-md-5 offset-md-1 m-0" style=""><svg width="15em" version="1.1" viewBox="0 0 27.13 28.661" xmlns="http://www.w3.org/2000/svg">
                <path d="m11.455 0v17.699h-8.414v-17.691c-1.9048 2.3556-3.0372 6.1606-3.0412 10.22-3.6804e-4 6.9464 3.2466 12.578 7.2497 12.578 4.0031 5.71e-4 7.2453-5.6314 7.245-12.578-0.0033-4.0612-1.1332-7.871-3.0391-10.228zm9.7792 14.166c-4.003-3.71e-4 -7.2459 3.2426-7.2456 7.2456-2.91e-4 4.0031 3.2426 7.25 7.2456 7.2497 2.3401-0.0032 4.5371-1.1384 5.8952-3.0437h-9.8294l4.1827-8.4119h5.6405c-1.3573-1.905-3.5501-3.0357-5.889-3.0396zm-16.199 4.191c0.54132 2.45e-4 0.98125 0.43731 0.98289 0.97875-2.49e-4 0.54226-0.44063 0.98264-0.98289 0.98289-0.54227-2.45e-4 -0.98058-0.44046-0.98082-0.98289 0.0022-0.54132 0.43954-0.97851 0.98082-0.97875zm4.4271 0c0.5423-0.0011 0.98126 0.43637 0.98289 0.97875-2.45e-4 0.54324-0.43936 0.98403-0.98289 0.98289-0.54231-2.45e-4 -0.98265-0.44046-0.98289-0.98289 0.0022-0.54132 0.44157-0.97851 0.98289-0.97875zm7.9416 0.12247c0.71186-0.0011 1.2907 0.57697 1.2909 1.2888-0.0011 0.71088-0.57999 1.2859-1.2909 1.2847-0.70896-0.0011-1.2832-0.57565-1.2847-1.2847 1.59e-4 -0.70994 0.57475-1.2873 1.2847-1.2888z" style="fill: #fff"></path>
              </svg></div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row py-3" style="">
        <div class="col-md-12 align-self-center order-1 order-md-2 my-3 text-md-left text-center">
          ...
          <p class="my-2 text-left text-body">Virtual Control は、できるだけ利用しやすい環境として HTML5 (+ CSS, JavaScript), PHP の2言語を使用しております。<br></p> <a class="btn btn-outline-light" href="https://github.com/ClearNB/Virtual-Control">GitHubページへ<br></a>
        </div>
      </div>
      <hr class="mt-0">
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center">
          <h2 class="pb-4" style="">SNMPを使った監視を、もっと気軽に</h2>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6" style="">
          <div class="card mt-1">
            <div class="card-header bg-secondary">標準MIBに準拠した監視を</div>
            <div class="card-body bg-primary" style="">
              <h4>OID識別を日本語メッセージに変換！</h4>
              <p>参照しなければ何の項目かわからないOIDを、標準MIBに準拠した日本語メッセージを搭載！<br>安心して気になった項目を監視できます。</p>
            </div>
          </div>
        </div>
        <div class="col-md-6" style="">
          <div class="card mt-1">
            <div class="card-header bg-secondary" style="">Webアプリケーションだから、導入もラク！</div>
            <div class="card-body bg-primary">
              <h4>Webサーバとしてカッコよく</h4>
              <p>Webアプリケーションとして稼働でき、そしてSNMPマネージャとしても稼働します。そのため、並列稼働しながら、運用を行うことができます。<br></p>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="py-5 section text-center bg-primary" id="reviews" style="">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active">
                <div class="blockquote ">
                  <p class="m-0" style="">Developed by Project GSC<br></p>
                  <div class="blockquote-footer text-body">本作品はProject GSC (日本工学院北海道専門学校) によって開発されました</div>
                </div>
              </div>
            </div>
          </div>
  ...
  <!-- Call to action -->
  <div class="bg-dark" id="login">
    <div class="container">
      <div class="row py-3">
        <div class="col-md-12 align-self-center text-center text-md-left" style="">
          <h1 class="text-center">監視するにはログインが必要です</h1>
          <p class="lead text-white text-center">ログインボタンをクリックして、ログインを行ってください</p>
          <div class="row mt-4">
            <div class="col-md-12 col-12"> <a class="btn btn-block btn-lg btn-primary" href="login.php">ログイン</a> </div>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- Footer -->
  <div class="bg-dark pt-0" style="">
    <div class="container">
      <div class="row">
        <div class="col-md-12 my-3 text-center">
          <p class="text-muted">© 2020 Project GSC All Rights Reserved.<br></p>
        </div>
      </div>
    </div>
  </div>
