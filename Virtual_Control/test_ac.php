...
$fm_fl->SubTitle('データベースサーバとの接続に失敗しました。', '以下をご確認ください。', 'fas fa-exclamination');
$fm_fl->openList();
$fm_fl->addList('データベースサーバと正しく接続できるか確認してください。');
$fm_fl->addList('データベースサーバのファイアウォール設定をご確認ください。');
$fm_fl->addList('Webサーバ側のデータベースサーバの接続設定をご確認ください。');
$fm_fl->closeList();
