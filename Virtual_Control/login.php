...
<body>
        ...
        <div class="col-md-12 text-lg-left text-center align-self-center my-2" style="">
          <div class="row">
            <div class="col-md-7 text-center" style="">
              <h1 class="text-body display-4">ログイン</h1>
              <p class="lead" style="">[Server_Name]</p>
              <h5 class="">[Description]</h5>
            </div>
            <div class="offset-md-1 col-md-5 m-0" style=""><svg width="15em" version="1.1" viewBox="0 0 27.13 28.661" xmlns="http://www.w3.org/2000/svg">
          ...
          <form class="">
            <div class="form-group" style=""> <label>【必須】ユーザID<br></label> <input type="email" class="form-control bg-dark my-1 form-control-lg shadow-sm" placeholder="Enter UserID" required="required" id="inputuserid"> <small class="form-text text-body">ユーザIDはVCServerによって振り分けられています。</small> </div>
            <div class="form-group pt-2"> <label>【必須】パスワード</label> <input type="password" class="form-control bg-dark form-control-lg shadow-sm" placeholder="Password" required="required" id="inputpassword"> <small class="form-text text-body">ユーザIDに割り当てられたパスワードを入力します。</small></div> <button type="submit" class="btn btn-dark btn-block btn-lg shadow-lg">ログイン</button>
          </form>
        </div>
      </div>
    </div>
  ...
  <div class="py-3" style="">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
          <p class="text-monospace" style="">本サイトのネットワーク管理者にご相談ください。本サーバの管理者はVCServerと呼称されます。<br>VCServerにお問い合わせする際は、以下のボタンリンクのメールアドレスでお願いいたします。</p>
        </div>
      </div>
    </div>
  </div>
