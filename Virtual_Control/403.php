...
<html>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12" style="">
          <h2 class="" style=""><i class="fa fa-fw fa-exclamation-triangle"></i>アクセスできません</h2>
          <p style="">このページは管理者権限 VCServer でログインしているユーザからのみアクセス可能です。<br></p>
        </div>
      </div>
    </div>
  </div>
  <div class="bg-primary py-3">
    <div class="container">
      <div class="row">
        <div class="col-md-12"><a class="btn btn-block btn-lg btn-dark" href="index.php"><i class="fa fa-fw fa-arrow-circle-o-left"></i>戻る</a></div>
      </div>
    </div>
  </div>
